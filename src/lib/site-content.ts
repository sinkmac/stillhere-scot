...
export const guidePages = {
  ...
  recordHomeTestimony: {
    ...
    body: [
      ...
      'A phone tripod or stand — costing under £15 — removes the shakiness of a handheld recording and lets you sit naturally opposite the person rather than holding a camera between you. [Amazon UK](https://www.amazon.co.uk/s?k=phone+tripod+stand&tag=biteforecast2-21)',
      'If the person speaks quietly or the room has background noise, a clip-on lapel microphone that plugs into your phone makes an immediate difference to audio quality. Good ones cost under £20. [Amazon UK](https://www.amazon.co.uk/s?k=lapel+microphone+phone&tag=biteforecast2-21)',
      'Framing.',
  ...
  familyArchive: {
    ...
    body: [
      ...
      'What you need.',
      'For scanning: a flatbed scanner produces archival-quality results at home. The Epson Perfection range is the standard recommendation — reliable, widely available, and handles photographs and documents equally well. [Amazon UK](https://www.amazon.co.uk/s?k=Epson+Perfection+scanner&tag=biteforecast2-21)',
      'For storage: acid-free archival photo sleeves protect photographs from deterioration. Standard plastic wallets accelerate damage over time — archival sleeves do not. [Amazon UK](https://www.amazon.co.uk/s?k=acid+free+photo+sleeves+archival&tag=biteforecast2-21)',
      'For labelling: write on the back of photographs in soft pencil only — never pen. A set of archival-quality pencils costs very little and lasts years. [Amazon UK](https://www.amazon.co.uk/s?k=archival+pencils+photographs&tag=biteforecast2-21)',
      'Documents.',
